...
<html lang="zxx" class="no-js">
	...
	<body>	
        ...
        <form method="post" action="admin-record-show.php">

        <table class="table table-borderless-small">
        	<tbody>
        		<tr>
        			<td><label for="sid">STUDENT ID</label></td>
        			<td><input type="text" name="sid" id="sid" placeholder="" ></td>
                </tr>
                    
            </tbody>
        </table>
           
        <a href="admin-record-show.php"><input name="Submit" type="submit" class="search-button" value="SEARCH"></a>
    	</form>
