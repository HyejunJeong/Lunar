...
<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>LUNAR: Current Record</title>
...
<div class="container">
    <?php
        ...
        //echo $sid;
        $sql = "SELECT Cl.semester, Cr.subject, Cr.crs, Cr.title, Cl.cmp, Cl.credits  
                FROM Courses Cr, Classes Cl, Takes T, Record R,
                	Contains Ct
                WHERE Cr.cid=Cl.cid AND semester='spring19' AND T.sid=$sid
...
*/
        ...
        <div class="table-title">
            APPLIED CREDIT: <?php echo "$sumcredit"; ?>
        </div>
        <br><br>
