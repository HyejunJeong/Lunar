...
GRANT ALL PRIVILEGES ON lunar.* to lunar@localhost IDENTIFIED BY 'lunar';
...
CREATE TABLE Students(
	...
	stype	VARCHAR(2) NOT NULL, -- G(Graduate) and UG(Undergraduate)
	PRIMARY KEY (sid)
);
...
-- GPA setup
INSERT INTO GPA(grade, point) VALUES ('A', 4.0), ('A-', 3.7), ('B+', 3.3), ('B', 3.0), ('B-', 2.7), 
	('C+', 2.3), ('C', 2.0), ('C-', 1.7), ('D+', 1.3), ('D', 1.0), ('E', 0.0), ('F', 0.0), ('Q', 0.0);
