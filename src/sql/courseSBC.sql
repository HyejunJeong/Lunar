...
-- AMS SBC fullfill
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, QPS 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, STEMP 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, SPK
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, WRTD 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, CER
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, ESI
	WHERE (subject="AMS" AND (crs=315 || crs=394 || crs=412))
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, EXPP
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, TECH 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, SBSP 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, STAS 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, SNW 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, SBS 
...
INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, LANG 
	WHERE (subject="CHI" AND (crs=111 || crs=112))
	   OR (subject="KOR" AND (crs=111 || crs=112 || crs=220));

INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, GLO 
	WHERE (subject="KOR" AND crs=220)
	   OR (subject="POL" AND crs=101);

INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, HUM 
	WHERE (subject="KOR" AND crs=220);

INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, ARTS
	WHERE (subject="MUS" AND crs=105);

INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, USA 
	WHERE (subject="POL" AND crs=102);

INSERT INTO Fullfils(cid, sbcid) SELECT cid, sbcid FROM Courses, WRT 
